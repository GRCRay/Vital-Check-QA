...
REG-03,Conflict,Voice input then Manual edit,System saves the manual edit,Pending
REG-04,Security+,Enter script <script> in name,Input rejected; Error displayed,Pending
